...
class PeopleEndpointTestCase(TestCase):
    ...
    def test_create_planet_not_found(self):
        ...
        self.assertEqual(response['Content-Type'], 'application/json')
        expected = {'homeworld': ['Invalid pk "9999" - object does not exist.']}
        self.assertEqual(response.json(), expected)
        self.assertEqual(People.objects.count(), 3)
    ...
    def test_create_invalid_payload(self):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response['Content-Type'], 'application/json')
        expected = {'height': ['A valid integer is required.']}
        self.assertEqual(response.json(), expected)
    ...
    def test_full_update_missing_fields(self):
        ...
        self.assertEqual(
            response.json(),
            {'homeworld': ['This field is required.']})
    ...
    def test_full_update_planet_not_found(self):
        ...
        self.assertEqual(
            response.json(),
            {'homeworld': ['Invalid pk "9999" - object does not exist.']})
    ...
    def test_full_update_invalid_field_value(self):
        ...
        self.assertEqual(
            response.json(),
            {'height': ['A valid integer is required.']})
